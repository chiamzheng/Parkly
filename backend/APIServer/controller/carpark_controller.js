const { fetch_reviews, fetch_carpark_rates, fetch_carpark_type, fetch_free_parking, fetch_location, fetch_parking_available_time, fetch_parking_system_type, fetch_carparks_within_radius, add_review } = require("../../src/controller/carpark_manager");
...
module.exports = { fetch_reviews_api, fetch_carpark_rates_api, fetch_carpark_type_api, fetch_free_parking_api, fetch_location_api, fetch_parking_available_time_api, fetch_parking_system_type_api, fetch_carparks_within_radius_api, add_review_api };
